...
export const ServerSettings = Schema.Struct({
  ...
  enableCommandQuickActions: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  enableCommandQuickActions: Schema.optionalKey(Schema.Boolean),
